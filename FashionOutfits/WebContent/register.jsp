		...
		<div class="container">
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="index.jsp">Fashion <span>Store</span></a></h1>
				</div>
	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form action="Register" method="post" class="animated wow slideInUp" data-wow-delay=".5s">
					<input type="text" placeholder="First Name..." name="fname" required="" >
					<input type="text" placeholder="Last Name..." name="lname" required="" >
				<input type="number" placeholder="Your Contact..." name="phone" required="">
				...
				<div class="animated wow slideInUp" data-wow-delay=".5s">
					...
					<input type="password" placeholder="Password Confirmation" name="conpass" required="">
